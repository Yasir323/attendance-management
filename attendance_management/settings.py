...
SECRET_KEY = 'django-insecure-m@fry-wgfbj!pkt)*q(wlx74opdqqqp3g_d!dw+j_!u9-g)-7!'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST', 'db'),  # This should be the name of the service in docker-compose
